    ...
    return  ModalProgressHUD(
      ...
      child:  Container(
        ...
        child: FutureBuilder<DocumentSnapshot>(
          future: FirebaseFirestore.instance.collection('NRL_Users').doc(user!.uid).get(),
                          ...
                          onPressed: () {
                            ...
                            if (isValid!) {
                              if(currentPassword == _newPasswordController.text){
                                ...
                                changeIslodding();
                                FirebaseFirestore.instance.collection('NRL_Users').doc(user!.uid).update({
